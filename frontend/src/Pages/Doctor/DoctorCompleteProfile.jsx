      ...
      <div className="profile-container">
        ...
        <div className="profile-header">
          ...
          <p>{isEditMode
            ...
            : "Fill in your professional details so patients can find and trust you"
          }</p>
        </div>
        ...
        <div className="profile-card">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <input name="qualification" placeholder="e.g. MBBS, MD, DM" value={form.qualification} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Experience (Years)</label>
              <input type="number" name="experienceYears" placeholder="e.g. 10" min="0" max="60" value={form.experienceYears} onChange={handleChange} />
            </div>
            <div className="form-group">
              <label>Consultation Fee (₹)</label>
              <input type="number" name="consultationFee" placeholder="e.g. 500" min="0" value={form.consultationFee} onChange={handleChange} />
            </div>
            <div className="form-group full-width">
              <label>Languages Spoken</label>
              <input name="languagesSpoken" placeholder="e.g. Hindi, English, Punjabi" value={form.languagesSpoken} onChange={handleChange} />
            </div>
          </div>
        </div>
        ...
        <div className="profile-card">
          ...
          <div className="form-grid three-col">
            <div className="form-group">
              ...
              <input name="registrationNumber" placeholder="e.g. MCI-12345" value={form.registrationNumber} onChange={handleChange} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="number" name="registrationYear" placeholder="e.g. 2015" min="1950" max={new Date().getFullYear()} value={form.registrationYear} onChange={handleChange} />
            </div>
          </div>
        </div>
        ...
        <div className="profile-card">
          ...
          <div className="form-grid one-col">
            <div className="form-group">
              ...
              <textarea name="bio" placeholder="Write a short professional bio..." value={form.bio} onChange={handleChange} rows={4} />
            </div>
            <div className="form-group">
              <label>Awards & Achievements</label>
              <textarea name="awards" placeholder="e.g. Best Doctor Award 2022..." value={form.awards} onChange={handleChange} rows={3} />
            </div>
          </div>
          <div className="submit-wrap">
            <button className="btn-skip" onClick={() => navigate("/Doctor/dashboard")}>
              {isEditMode ? "← Back to Dashboard" : "Skip for now"}
            </button>
